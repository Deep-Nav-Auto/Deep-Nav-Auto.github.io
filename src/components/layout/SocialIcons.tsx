...
export function SocialIcons() {
  ...
  const links = [
    ...
    social.orcidId && {
      href: `https://orcid.org/${social.orcidId}`,
      icon: OrcidIcon,
      label: "ORCID",
    },
    social.scholarUserId && {
      href: `https://scholar.google.com/citations?user=${social.scholarUserId}`,
      icon: ScholarIcon,
      label: "Google Scholar",
    },
    social.researchGateProfile && {
      href: `https://www.researchgate.net/profile/${social.researchGateProfile}`,
      icon: ResearchGateIcon,
      label: "ResearchGate",
    },
    social.ieeeId && {
      href: `https://ieeexplore.ieee.org/author/${social.ieeeId}`,
      icon: IeeeIcon,
      label: "IEEE Xplore",
    },
    social.linkedin && {
      ...
      {links.map((link, i) => {
        ...
        return (
          <Link
            ...
            className="text-[var(--text-muted)] transition-colors hover:text-[var(--theme-color)]"
